    ...
    public class CustomersController : ControllerBase
    {
        ...
        public IActionResult Post([FromBody] Customer customer)
        {
            ...
            using (var sqlConnection = new MySqlConnection(connectionString))
            {
                ...
                if (affectedRows > 0)
                {
                    return StatusCode(200, "Thêm mới khách hàng thành công");
                }
                else
                {
        ...
        public IActionResult Put(Guid customerId, [FromBody] Customer updatedCustomer)
        {
            ...
            using (var sqlConnection = new MySqlConnection(connectionString))
            {
                ...
                if (rowsAffected > 0)
                {
                    return StatusCode(200, "Cập nhật khách hàng thành công.");
                }
                else
                {
        ...
        public IActionResult Delete(Guid customerId)
        {
            ...
            using (var sqlConnection = new MySqlConnection(connectionString))
            {
                ...
                if (rowsAffected > 0)
                {
                    return StatusCode(200, "Xóa khách hàng thành công.");
                }
                else
                {
